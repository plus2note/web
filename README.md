...
WordPress is free software and is released under the terms of the [GPL (GNU General Public License) version 2 or (at your option) any later version](license.txt).
